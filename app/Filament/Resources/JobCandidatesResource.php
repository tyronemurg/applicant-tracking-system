...
class JobCandidatesResource extends Resource
{
        ...
        return $form
            ->schema(
                array_merge([],
                    ...
                    self::additionalInformationFormLayout(),
                //     Card::make()
                // ->schema([
    ...
    public static function additionalInformationFormLayout(): array
{
    return [
            ...
            ->columns([
                ...
                ->formatStateUsing(function ($state, $record) {
                    ...
                    return $attachments->map(function ($attachment) {
                        return '<a href="' . Storage::url($attachment->attachment) . '" target="_blank">' . $attachment->attachmentName . '</a>';
                    })->join(', ');
                })
                ->html(),
